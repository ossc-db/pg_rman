...
const char *PROGRAM_VERSION	= "1.2.11";
const char *PROGRAM_URL		= "http://sourceforge.net/projects/pg-rman/";
const char *PROGRAM_EMAIL	= "http://sourceforge.net/p/pg-rman/tickets/";
