...
* REL_13_STABLE : branch for PostgreSQL 13.0 [![Build Status](https://travis-ci.org/ossc-db/pg_rman.svg?branch=REL_13_STABLE)](https://travis-ci.org/ossc-db/pg_rman)
...
# recovery.conf generated by pg_rman 1.3.10
